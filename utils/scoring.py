...
def extraer_equipos_reales_por_ronda(resultados: pd.DataFrame) -> dict:
    ...
    Un equipo que llegó a semis también cuenta como que llegó a 4tos, 8vos, etc.
    """
    if resultados.empty:
        return {}
    
    # Primero, determinar la fase MÁXIMA de cada equipo
    fase_maxima = {}  # equipo → orden máximo
    ...
    # Construir acumulado (misma lógica que Total Results)
    equipos_por_ronda = {
